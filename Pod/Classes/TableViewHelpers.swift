...
extension UITableView {
    public final func registerReusableCell<T where T: UITableViewCell>(_ cell: ReusableCell<T>) {
        switch cell {
    ...
    public final func dequeueReusableCell<T where T: UITableViewCell>(_ cell: ReusableCell<T>, indexPath: IndexPath) -> T {
